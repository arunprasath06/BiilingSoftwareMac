...
class Home:
    def HomeScreen(self, root):
        ...
        # b6 = customtkinter.CTkButton(master=fhome, text="List All Customers", command=create_ManageCustomerScreen, )
        # b6.pack(padx=10, pady=10, ipadx=25, side="top", expand=True, anchor='n')
    ...
    def Screen(root):
        ...
        def CheckCustomer():
            ...
            if (db.AddCustomer(name, address, tel, email)):
                ...
                def abcd():
                    alertlabel.configure(text=f"This Email has already been registered!", text_color="Red")
                    alertlabel.update()
                    time.sleep(3)
...
class CreateInvoice:
    ...
    def Screen(root):
        ...
        cie7 = customtkinter.CTkEntry(master=fci, placeholder_text="Description")
